...
const TirupatiPackages = () => {
  ...
  const packages = [
    {
      id: 'TPT0001',
      title: 'Tirupati Local Temples - Padmavati Temple',
      description: 'Visit local Tirupati temples including the sacred Padmavati Temple.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/tirumala-tirupati-local-2.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.2750' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.3500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.4000' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.4500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.5650' }
      ]
    },
    {
      id: 'TPT0002',
      title: 'Tirupati Local Temples - Srinivasa Mangapuram - Vakulamatha - Chandragiri Fort',
      description: 'Comprehensive tour covering multiple sacred sites and historical fort.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Tirupati-Local-Temples-Srinivasa-Mangapuram-Chandragiri-Fort-Vakulamata.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4000' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.4700' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.5300' },
        { vehicle: 'Innova Crysta 7 Seater', price: 'Rs.6000' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.6900' }
      ]
    },
    {
      id: 'TPT0003',
      title: 'Srinivasa Mangapuram - Talakona Waterfalls',
      description: 'Spiritual journey combined with natural beauty at Talakona Waterfalls.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Srinivasa-Mangapuram-Talakona-Waterfalls.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4900' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.5300' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.6500' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.7100' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.8500' }
      ]
    }
  ];

  const handleWhatsAppBooking = (pkg: { id: any; title: any; description: any; pricing: any; image?: string; }) => {
    const message = `🙏 *TIRUPATI TAXI PACKAGE BOOKING*
...
💰 *VEHICLE PRICING:*
${pkg.pricing.map((item: { vehicle: any; price: any; }) => `• ${item.vehicle}: ${item.price}`).join('\n')}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-6 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3">Tirupati Taxi Packages</h1>
            <p className="text-sm md:text-base lg:text-lg opacity-90 max-w-4xl mx-auto leading-relaxed">
              Explore Tirupati's local temples and attractions with our comfortable taxi services. 
              Choose from our fleet of well-maintained vehicles for your spiritual journey.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center items-center my-6">
        <button
          onClick={() => handleWhatsAppBooking({ id: '', title: 'Tirupati Taxi Package', description: '', pricing: [] })}
          className="bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-2 rounded-full flex items-center justify-center hover:from-green-700 hover:to-green-800 transition-all duration-300 text-base font-semibold shadow-lg"
        >
        ...
        <a
          ...
          className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-2 rounded-full flex items-center justify-center hover:from-orange-700 hover:to-red-700 transition-all duration-300 text-base font-semibold shadow-lg"
        >
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
            ...
            <ul className="space-y-1">
              ...
              <li>• AC off during ghat roads</li>
