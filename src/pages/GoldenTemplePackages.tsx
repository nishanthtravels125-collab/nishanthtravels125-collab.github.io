...
const GoldenTemplePackages = () => {
  ...
  const packages: Package[] = [
    {
      id: 'GOL0001',
      title: 'Golden Temple - Srinivasa Mangapuram',
      description: 'Visit the magnificent Golden Temple in Vellore with Srinivasa Mangapuram.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Golden-Temple-Srinivasa-Mangapuram-Tirumala-Dropping%E2%80%83.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.5500' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.6500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.7500' },
        { vehicle: 'Innova Crysta 7 Seater', price: 'Rs.8500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.10000' }
      ]
    },
    {
      id: 'GOL0002',
      title: 'Golden Temple - Kanipakam - Padmavati Temple',
      description: 'Comprehensive tour covering Golden Temple, Kanipakam and Padmavati Temple.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Golden-Temple-Kanipakam-Padmavati-Temple.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.5850' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.6850' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.7850' },
        { vehicle: 'Innova Crysta 7 Seater', price: 'Rs.8550' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.10550' }
      ]
    },
    {
      id: 'GOL0003',
      title: 'Golden Temple - Kanchipuram - Tirutani - Padmavathi Temple (One Day)',
      description: 'Full day spiritual journey covering multiple sacred destinations.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Golden-Temple-Kanchipuram.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.7650' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.8550' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.10550' },
        { vehicle: 'Innova Crysta 7 Seater', price: 'Rs.11000' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.14500' }
      ]
    },
    {
      id: 'GOL0004',
      title: 'Golden Temple - Kanipakam - Tiruvannamalai Temple (One Day)',
      description: 'Extended spiritual tour to Golden Temple, Kanipakam and Tiruvannamalai.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/1.jpeg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.8250' },
        { vehicle: 'Innova Crysta 7 Seater', price: 'Rs.12550' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.15550' }
      ]
    }
  ];

  const handleWhatsAppBooking = (pkg: Package) => {
    const message = `🙏 *GOLDEN TEMPLE TAXI PACKAGE BOOKING*
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-6 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3">Golden Temple Packages</h1>
            <p className="text-sm md:text-base lg:text-lg opacity-90 max-w-4xl mx-auto leading-relaxed">
              Online Car Rental from Tirupati to Vellore Golden Temple and get best deals on your cab booking. 
              Experience the magnificent Golden Temple with our comfortable taxi services.
            </p>
          </div>
        </div>
      </div>
...
export default GoldenTemplePackages;