...
const KanipakamPackages = () => {
  ...
  const packages = [
    {
      id: 'KAN0001',
      title: 'Kanipakam - Srinivasa Mangapuram - Padmavathi Temple',
      description: 'Sacred journey covering Kanipakam Ganesha temple and other holy sites.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kanipakam-Srinivasa-Mangapuram-Padmavathi-Temple%E2%80%83.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4700' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.5500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.6000' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.6500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.8000' }
      ]
    },
    {
      id: 'KAN0002',
      title: 'Kanipakam - Ardhagiri Hanuman Temple - Srinivasa Mangapuram',
      description: 'Visit Kanipakam temple with Hanuman temple and Srinivasa Mangapuram.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kanipakam-Ardhagiri-Hanuman-Temple-Srinivasa-Mangapuram.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.5200' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.5900' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.6500' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.7000' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.9000' }
      ]
    },
    {
      id: 'KAN0003',
      title: 'Kanipakam - Golden Temple - Srinivasa Mangapuram',
      description: 'Spiritual tour combining Kanipakam, Golden Temple and Srinivasa Mangapuram.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kanipakam-Golden-Temple-Srinivasa-Mangapuram.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.5500' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.6000' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.6500' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.7500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.9500' }
      ]
    },
    {
      id: 'KAN0004',
      title: 'Kanipakam - Golden Temple - Arunachalam (Tiruvannamalai)',
      description: 'Extended spiritual journey to Kanipakam, Golden Temple and Arunachalam.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kanipakam-Tiruvannamalai-Temple-Arunachalam.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.8000' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.8700' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.9500' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.11000' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.14500' }
      ]
    },
    {
      id: 'KAN0005',
      title: 'Kanipakam - Kalahasti - Padmavati - Vakulamatha Temple',
      description: 'Comprehensive temple tour covering multiple sacred destinations.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kanipakam-Kalahasti-Temple.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.6500' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.7500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.9500' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.10500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.12500' }
      ]
    }
  ];
  ...
  const handleWhatsAppBooking = (pkg: Package) => {
    const message = `🙏 *KANIPAKAM TAXI PACKAGE BOOKING*
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-6 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3">Kanipakam Packages</h1>
            <p className="text-sm md:text-base lg:text-lg opacity-90 max-w-4xl mx-auto leading-relaxed">
              Online Car Rental from Tirupati to Kanipakam and get best deals on your cab booking. 
              Visit the famous Kanipakam Ganesha temple with our comfortable taxi services.
            </p>
          </div>
        </div>
      </div>
...
export default KanipakamPackages;