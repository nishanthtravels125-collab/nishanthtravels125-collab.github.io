...
const SriKalahastPackages = () => {
  ...
  const packages = [
    {
      id: 'KAL0001',
      title: 'Kalahasti Temple - Gudimallam Shiva Temple - Padmavati Temple',
      description: 'Sacred journey covering three important temples in one day.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kalahasti-Temple-Gudimallam-Shiva-Temple-Padmavati-Temple.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4000' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.4500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.5000' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.6000' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.7500' }
      ]
    },
    {
      id: 'KAL0002',
      title: 'Kalahasti Temple - Tirupati Local Temples',
      description: 'Combined tour of Kalahasti and Tirupati local temples.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/Kalahasti-Temple-Tirupati-Local-Temples-%E2%80%83.jpg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4500' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.5200' },
    ...
    {
      id: 'KAL0003',
      title: 'Kalahasti - Padmavati - Vakulamatha - Srinivasa Mangapuram',
      description: 'Comprehensive spiritual tour covering multiple sacred sites.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/3.jpeg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.4000' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.4500' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.5000' },
    ...
    {
      id: 'KAL0004',
      title: 'Kalahasti - Padmavati Temple',
      description: 'Visit the famous Kalahasti and Padmavati temples.',
      image: 'https://vishnu-travels.com/wp-content/uploads/2024/01/4.jpeg',
      pricing: [
        { vehicle: 'Dzire, Etios 4 Seater', price: 'Rs.3500' },
        { vehicle: 'Ertiga 6 Seater', price: 'Rs.4100' },
        { vehicle: 'Innova / Tavera 7 Seater', price: 'Rs.5100' },
        { vehicle: 'Innova Crysta 6,7 Seater', price: 'Rs.5500' },
        { vehicle: 'Tempo Traveler 12 Seater', price: 'Rs.6500' }
      ]
    }
  ];

  const handleWhatsAppBooking = (pkg: typeof packages[number]) => {
    const message = `🙏 *SRI KALAHASTI TAXI PACKAGE BOOKING*
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white py-6 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3">Sri Kalahasti Packages</h1>
            <p className="text-sm md:text-base lg:text-lg opacity-90 max-w-4xl mx-auto leading-relaxed">
              Online Car Rental from Tirupati to Kalahasti and get best deals on your cab booking. 
              Our fleet includes all cab types AC, Non AC, Economical, SUV, Sedan and Tempo Traveler.
            </p>
          </div>
        </div>
      </div>
...
export default SriKalahastPackages;